...
public class DecimalActivity extends AppCompatActivity {
    ...
    public void numberPressed(View v)
    {
        ...
        textViewDecimal.setText(textViewDecimal.getText().toString()+input);

    }
    public void clearBtn(View v)
    {
        textViewDecimal.setText("");
    ...
    {
        String str=textViewDecimal.getText().toString();
        if(str!=null && str.length()>1) {
            textViewDecimal.setText(str.substring(0, str.length() - 1));
    ...
    public void result(View v) {
        String exp = textViewDecimal.getText().toString();
        if(exp.equals(""))
        {
            textViewDecimal.setText("");
            textViewBinary.setText("Binary :                        ");
        ...
        for (int i = 0; i < operandList.size(); i++) {
            operandsInDecimal.add(i, Integer.toString(Integer.parseInt(operandList.get(i), 10), 10));
        }
        ...
        if (operandsInDecimal.size() != (operatorList.size() + 1)) {
            ...
            textViewQuestion.setText(expressionDecimal);
            ...
            textViewDecimal.setText(DecimalResult);
