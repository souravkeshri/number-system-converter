...
public class HexaDecimalActivity extends AppCompatActivity {
    ...
    public void numberPressed(View v)
    {
        ...
        textViewHexaDecimal.setText(textViewHexaDecimal.getText().toString()+input);

    }
    public void clearBtn(View v)
    {
        textViewHexaDecimal.setText("");
        textViewBinary.setText("Binary :                        ");
        textViewDecimal.setText("Decimal :                      ");
        textViewOctal.setText("Octal :                   ");
        textViewQuestion.setVisibility(View.INVISIBLE);
    }
    public void trim(View v)
    {
        String str=textViewHexaDecimal.getText().toString();
        if(str!=null && str.length()>1) {
            textViewHexaDecimal.setText(str.substring(0, str.length() - 1));
    ...
    public void result(View v) {
        String exp = textViewHexaDecimal.getText().toString();
        ...
        for (int i = 0; i < operandList.size(); i++) {
            operandsInDecimal.add(i, Integer.toString(Integer.parseInt(operandList.get(i), 16), 10).toUpperCase());
        }

        ArrayList<String> DecExpression = new ArrayList<String>(operandsInDecimal.size());
        ArrayList<String> HexExpression = new ArrayList<String>(operandsInDecimal.size());
        if (operandsInDecimal.size() != (operatorList.size() + 1)) {
            ...
            textViewOctal.setText("Octal       :  " + Integer.toString(Integer.parseInt(DecimalResult, 10), 8));
            textViewHexaDecimal.setText(Integer.toString(Integer.parseInt(DecimalResult, 10), 16).toUpperCase());
    ...
    {
        Intent intent=new Intent(HexaDecimalActivity.this,MainActivity.class);
